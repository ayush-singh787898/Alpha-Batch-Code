...
public class L07_Diameter_Of_Tree {
    static class Node{
        int data;
        Node left;
        Node right;
        Node(int data){
            ...
            public static int diameter(Node root){      // time complexity: O(n^2)
                ...
                int selfDiameter=leftHeight+rightHeight+1;       // 1 is used for self node
                return Math.max(selfDiameter,Math.max(leftDimeter,rightDiamter));
