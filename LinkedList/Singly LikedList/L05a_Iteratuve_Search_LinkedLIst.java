...
public class  L05a_Iteratuve_Search_LinkedLIst{
    ...
    // Iterative Search :- check whether key is present present or not
    public boolean  itrSearch(int key){         // time  complexity for iteration is O(n)
        Node temp=head;
        while(temp!=null){
            if(temp.data==key){
                return true;
    ...
    public static void main(String[] args) {
        L05a_Iteratuve_Search_LinkedLIst ll=new L05a_Iteratuve_Search_LinkedLIst();
        ll.print();
        ll.addFirst(2);
        ll.print();
        ll.addFirst(1);
