...
public class  L05b_Recursive_Approach_To_Search_key_LinkedList{
    ...
    public  int helper(Node head,int key){      // time complexity and space complexity(b/c n stack required) is linear O(n)
        if(head==null){
            return -1;
        }
        if(head.data==key){
    ...
    public static void main(String[] args) {
        L05b_Recursive_Approach_To_Search_key_LinkedList ll=new L05b_Recursive_Approach_To_Search_key_LinkedList();
        ll.print();
        ll.addFirst(2);
        ll.print();
        ll.addFirst(1);
