...
public class  L09_Cycyle_In_LinkedList{
   ...
   // mid-node calculation
    ...
    public static void main(String[] args) {
         L09_Cycyle_In_LinkedList ll=new  L09_Cycyle_In_LinkedList();
        // ll.print();
        // ll.addFirst(1);
        // // ll.print();
        // ll.addFirst(2);
        ...
        head.next.next.next.next=head;          // using this line we get true otherwize false
